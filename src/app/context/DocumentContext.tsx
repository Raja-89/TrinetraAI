...
interface DocumentContextType {
  data: DocumentData;
  mockUpload: (fileName?: string) => void;
}
...
export function DocumentProvider({ children }: { children: ReactNode }) {
  ...
  const mockUpload = (fileName?: string) => {
    ...
    setCurrentTitle(fileName || null);
  };

  const currentData = { ...SCENARIOS[currentIndex] };
  if (currentTitle) {
    currentData.title = currentTitle;
  }

  return (
    <DocumentContext.Provider value={{ data: currentData, mockUpload }}>
      {children}
